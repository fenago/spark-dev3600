...
**Note:** 
- Solutions are present in `work/spark-dev3600/Lab1` folder. Copy and paste the solution in the terminal(s) after running command `spark-shell` (for Scala) or `pyspark` (for Python).
